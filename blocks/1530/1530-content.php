			...
			<div class=post-content>
				...
				<article class="post-527">
					<figure class="post_type_img">
						<img src="./images/agriculture-36-150x150.jpg" class="img-thumbnail" alt="Autumn Harvest" >
					</figure>
					<header>
						<h4 class="entry-title">
							<a href="http://agriculture.cmsmasters.net/standard-post-with-an-image/">Autumn Harvest</a>
						</h4>
					</header>
				...
				<article class="post-489">
					<figure class="post_type_img">
						<img src="./images/agriculture-32-150x150.jpg" class="img-thumbnail" alt="Autumn Harvest" >
					</figure>

					<header>
						<h4 class="entry-title">
							<a href="http://agriculture.cmsmasters.net/quote-post-format/">Growing Turnips</a>
						</h4>
					</header>
