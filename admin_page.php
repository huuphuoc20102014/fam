                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title"> <span class="icon"><a href="add.php"> <i class="icon-plus"></i> </a></span>
                                <h5>Products</h5>
                            </div>
                                ...
                                <table  class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($products as $key => $product): ?>
                                            <tr class="">
                                                <td>
                                                    <img src="<?php echo 'images/' . $product['product-images']; ?>" alt="#"  class="img-responsive" width="10%">
                                                </td>
                                                <td><?php echo $product['product-name']; ?></td>
                                                <td><?php echo $product['product-category-id']; ?></td>
                                                <td><?php echo number_format($product['product-price'], 0, ',', '.'); ?> ₫</td>
                                                <td>
                                                    <a href="edit.php?id=<?php echo $product['product-id'] ?>" class="btn btn-success btn-mini">Edit</a>

                                                    <a href="admin_page.php?id=<?php echo $product['product-id'] ?>" class="btn btn-danger btn-mini">Delete</a>
