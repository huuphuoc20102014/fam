...
<html lang="en">
                                ...
                                <form action="admin_page.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="file" name="product-images" id="fileUpload">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span11" placeholder="price" name="product-price" /> *
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span11" placeholder="sale" name="sale" /> *
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <input type="submit" value="Thêm mới" style="background: blue; color: #fff;">
                                    </div>
    ...
    <?php
    if (isset($_GET['product-category-id'])) {
        $data = [
            'product-category-id' => $_GET['product-category-id'],
            'product-name' => $_GET['product-name'],
            'product-price' => $_GET['product-price'],
            'product-images' => $_GET['product-images'],
            'sale' => $_GET['sale']
        ];
